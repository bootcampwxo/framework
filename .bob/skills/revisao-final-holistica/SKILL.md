...
2) **Valide contra 5 dimensões**, nesta ordem:
...
4) **Não permita que o fluxo termine com achados CRÍTICOS ou ALTOS não resolvidos.** Roteie a remediação de volta para o modo apropriado (Desenvolvedor para código, Testador para cobertura, Redator para docs), aguarde a correção, e reexecute esta revisão até que fique limpa.
